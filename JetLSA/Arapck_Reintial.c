...
{ 
  ...
  if (!restore (file = "Base", list = {Ubase.x,Ubase.y})) {
      ...
      input_grd_U(Ubase.x, file = "/mnt/d/basilisk/gongminjiang/paper2/NewJet/jet/BaseFlow/r0.25/Lam1.3/mask/U.asc");
      input_grd_V(Ubase.y, file = "/mnt/d/basilisk/gongminjiang/paper2/NewJet/jet/BaseFlow/r0.25/Lam1.3/mask/V.asc");
      input_grd_Phi(Phibase, file = "/mnt/d/basilisk/gongminjiang/paper2/NewJet/jet/BaseFlow/r0.25/Lam1.3/mask/Phi.asc");
  ...
  FILE * fpPhi = fopen("/mnt/d/basilisk/gongminjiang/paper2/NewJet/jet/BaseFlow/r0.25/Lam1.3/mask/Phibase_reinitialization.asc","w");
  output_grd(Phibase, fpPhi, 1./N, true, {{0,-2},{L0,2}});
  fclose(fpPhi);

  input_grd_Phi(Phibase, file = "/mnt/d/basilisk/gongminjiang/paper2/NewJet/jet/BaseFlow/r0.25/Lam1.3/mask/Phibase_reinitialization.asc");
  output_ppm (Phibase, file = "Phibase.png");
