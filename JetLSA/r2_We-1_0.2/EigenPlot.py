...
v = np.linspace(-max(map(max,zi)), max(map(max,zi)), 80, endpoint=True)
Power0 = plt.contourf(xi, yi, zi, v,cmap = "RdBu_r", extend="both")#plt.cm.coolwarm
