...
{ 
  ...
  if (!restore (file = "Base", list = {Ubase.x,Ubase.y})) {
      ...
      input_grd_U(Ubase.x, file = "/home/xiaopanggmj/Public/LSA/LSA/2021_Schmid/Two-Phase_Sigma/LatestBase/u.nwithconserving/U.asc");
      input_grd_V(Ubase.y, file = "/home/xiaopanggmj/Public/LSA/LSA/2021_Schmid/Two-Phase_Sigma/LatestBase/u.nwithconserving/V.asc");
      input_grd_Phi(Phibase, file = "/home/xiaopanggmj/Public/LSA/LSA/2021_Schmid/Two-Phase_Sigma/LatestBase/u.nwithconserving/Phi.asc");
      input_grd_f(f, file = "/home/xiaopanggmj/Public/LSA/LSA/2021_Schmid/Two-Phase_Sigma/LatestBase/u.nwithconserving/f.asc");
...
//   }
      input_grd_U(u.x, file = "../Initial/ux.asc");
      input_grd_V(u.y, file = "../Initial/uy.asc");
      input_grd_Phi(phi, file = "../Initial/phi.asc");
      foreach(){
        u.x[]*=1e-6;
        u.y[]*=1e-6;
        phi[]*=1e-6;
